...
import TogglerUncontrolled from '../../src/TogglerUncontrolled';
...
describe('Controlled Toggler', () => {
  it('should shallow a default toggler', () => {
    const toggler = shallow(<Toggler >{content}</Toggler>);
    expect(toggler).toMatchSnapshot();
  });

  it('should render a default toggler', () => {
    const toggler = render(<Toggler >{content}</Toggler>);
    expect(toggler).toMatchSnapshot();
  });

  it('should mount a default toggler', () => {
    const toggler = mount(<Toggler >{content}</Toggler>);
    expect(toggler).toMatchSnapshot();
  });
});

describe('Uncontrolled Toggler', () => {
  it('should shallow a default toggler', () => {
    const toggler = shallow(<TogglerUncontrolled >{content}</TogglerUncontrolled>);
    expect(toggler).toMatchSnapshot();
  });

  it('should render a default toggler', () => {
    const toggler = render(<TogglerUncontrolled >{content}</TogglerUncontrolled>);
    expect(toggler).toMatchSnapshot();
  });

  it('should mount a default toggler', () => {
    const toggler = mount(<TogglerUncontrolled >{content}</TogglerUncontrolled>);
    expect(toggler).toMatchSnapshot();
  });
});
